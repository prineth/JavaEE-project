...
import model.adminModel.mod_roomAdd;
...
public class roomAdd extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet roomAdd</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet roomAdd at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//        processRequest(request, response);
        ...
        mod_roomAdd addRoomObj = new mod_roomAdd();
        addRoomObj.addRoom(room_type,room_status,room_charge,room_quantity,room_description);
