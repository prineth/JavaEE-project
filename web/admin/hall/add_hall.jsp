        ...
        <div class="container-fluid">
            <div class="row">
                <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                    <div class="position-sticky">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="admin_halls.jsp">
                                    <!-- <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg> -->
                ...
                <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                    ...
                    <form action="../../admin_halls.jsp" method="POST">  
                        <button type="submit" class="btn btn-dark"> Back to hall</button>
                    </form><br>

                    <h1 class="h2">Add new hall</h1>
                    ...
                    <div class="row my-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="./deleteres" method="POST">
                                ...
                                <br>
                                <button type="submit" class="btn btn-warning">Add hall</button>
                            </form>
                        </div>
