                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th scope="row"><%=rs.getInt("room_id")%></th>
                                                    <td><%=rs.getString("room_type")%></td>
                                                    <td><%=rs.getString("room_bookStatus")%></td>
                                                    <td><%=rs.getFloat("room_charge")%></td>
                                                    <td><%=rs.getInt("room_quantity")%></td>
                                                    <td><%=rs.getString("room_description")%></td>
                                                </tr>
                                            </tbody>
                                    </div>
