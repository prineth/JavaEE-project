            ...
            <div class="row">
                ...
                <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th scope="row"><%=rs.getInt("hall_id")%></th>
                                                    <td><%=rs.getString("hall_type")%></td>
                                                    <td><%=rs.getString("hall_bookStatus")%></td>
                                                    <td><%=rs.getFloat("hall_price")%></td>
                                                    <td><%=rs.getInt("hall_quantity")%></td>
                                                    <td><%=rs.getString("description_desc")%></td>
                                                </tr>
                                            </tbody>
                                    </div>
                    ...
                    <div class="col-12 col-xl-4">
                        <div class="card">
                            <h5 class="card-header">Halls last 6 months</h5>
                            <div class="card-body">
                    ...
                    <div class="row"style="margin-top:15px;">
                        ...
                        <div class="card col-sm-3" style="width: 25rem; margin-right:15px; margin-left:12px;">
                            <div class="card-body">
                                <h5 style="font-weight: bolder">Add Hall</h5>
                                <br>
                                <p class="card-text" >You can add user here<br> Click the button</p>
                                <form action="admin/hall/add_hall.jsp" method="POST">  
                                    <br>
                                    <button type="submit" class="btn btn-warning">Add new hall</button>
                                </form>
                            </div>
                        </div>
                        <div class="card col-sm-3" style="width: 25rem; margin-right:15px;">
                            <div class="card-body">
                                <h5 style="font-weight: bolder">Update Hall</h5>
                                <br>
                        ...
                        <div class="card col-sm-3" style="width: 25rem;">
                            <div class="card-body">
                                <h5 style="font-weight: bolder">Delete Hall</h5>
                                <br>
                                <p class="card-text" >Enter the reservation id delete your reservation</p>
                                <form action="./deleteres" method="POST">  
                                    <div class="form-outline">
