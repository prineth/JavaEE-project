            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <img
                        ...
                        class="d-block w-100 shadow-1-strong rounded mb-4"
                        alt="..."
                        />
...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <img src="Assets/image/aboutUs/aboutUs.jpg" class="d-block w-100 shadow-1-strong rounded mb-4" style="height: 400px;"> 
        </div>
        <div class="col-lg-6">
            <h2>Our story</h2>
